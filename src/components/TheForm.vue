<template>
  <form @submit.prevent="submitForm">
    <div class="form-control" :class="{invalid: userNameValidity === 'invalid'}">
      ...
      <p v-if="userNameValidity === 'invalid'">Please enter a valid data</p>
    </div>
    ...
    <div class="form-control">
      ...
      <div>
        <input id="how-blogs" name="how" type="radio" value="radio" v-model="how"/>
      ...
      <div class="form-control">
        ...
        <label for="confirm-terms">Agre of terms of use?</label>
      </div>
    </div>
    <div>
